...
Ce programme cree et initialise un tableau de 10 couleurs, on utilise struct pour la couleur. 
Les couleurs sont intialisees en notation hexadécimale (r : 0xef, g : 0x78 etc.).
